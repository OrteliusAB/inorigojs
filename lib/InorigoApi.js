...
var InorigoAPI = /*#__PURE__*/function () {
  ...
  _createClass(InorigoAPI, [{
    ...
    value: function versoRuntime() {
      ...
      return {
        ...
        getTooltip: function getTooltip(vrid, componentID, row, column) {
          return _axios.default.get("".concat(_this2.BASE_URL_API, "application/runtime/").concat(vrid, "/cell/tooltip").concat(_this2.buildURIParams({
        ...
        evaluateExpression: function evaluateExpression(vrid, expression) {
          return _axios.default.get("".concat(_this2.BASE_URL_API, "application/runtime/").concat(vrid, "/evaluate?expression=").concat(expression), _this2.DEFAULTCONFIG);
        },
        setRuntimeVariable: function setRuntimeVariable(vrid, name, type, element, value) {
          ...
          return _axios.default.post("".concat(_this2.BASE_URL_API, "application/runtime/").concat(vrid, "/set/runtime/value"), payload, _this2.DEFAULTCONFIG);
        },
        lockSelection: function lockSelection(vrid, where) {
          return _axios.default.post("".concat(_this2.BASE_URL_API, "application/runtime/").concat(vrid, "/lock/selection").concat(_this2.buildURIParams({
            where: where
          })), {}, _this2.DEFAULTCONFIG);
        },
        unlockSelection: function unlockSelection(vrid, where) {
          return _axios.default.post("".concat(_this2.BASE_URL_API, "application/runtime/").concat(vrid, "/unlock/selection").concat(_this2.buildURIParams({
            where: where
          })), {}, _this2.DEFAULTCONFIG);
        },
        focusComponent: function focusComponent(vrid, component) {
          return _axios.default.post("".concat(_this2.BASE_URL_API, "application/runtime/").concat(vrid, "/component/focus/").concat(component), {}, _this2.DEFAULTCONFIG);
        }
      };
    }
    ...
    value: function entity() {
      ...
      return {
        ...
        getGraphDependencies: function getGraphDependencies(entityType, uuid) {
          ...
          return _axios.default.get("".concat(_this4.BASE_URL_API, "entity/").concat(entityType, "/").concat(uuid, "/dependencies/graph").concat(_this4.buildURIParams({
        ...
        getPossibleEntityReferences: function getPossibleEntityReferences(entityType, uuid) {
          return _axios.default.get("".concat(_this4.BASE_URL_API, "entity/possible/references").concat(_this4.buildURIParams({
            type: entityType,
            id: uuid
          })), _this4.DEFAULTCONFIG);
        },
        getPossibleInstanceReferences: function getPossibleInstanceReferences(definitionType, uuid) {
          return _axios.default.get("".concat(_this4.BASE_URL_API, "entity/possible/instance/references").concat(_this4.buildURIParams({
            type: definitionType,
            id: uuid
          })), _this4.DEFAULTCONFIG);
        },
        getPresentation: function getPresentation(entityType, uuid, povAttributeID) {
          return _axios.default.get("".concat(_this4.BASE_URL_API, "entity/").concat(entityType, "/").concat(uuid, "/presentation").concat(_this4.buildURIParams({
        ...
        getDependencyEdges: function getDependencyEdges(entityType, uuid) {
          ...
          var instances = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : true;
          var presentations = arguments.length > 8 && arguments[8] !== undefined ? arguments[8] : true;
          return _axios.default.get("".concat(_this4.BASE_URL_API, "entity/").concat(entityType, "/").concat(uuid, "/dependencies/edges").concat(_this4.buildURIParams({
            dependants: dependants,
            dependencies: dependencies,
            values: values,
            references: references,
        ...
        getEntityIcon: function getEntityIcon(entityType, uuid, size, contextID) {
          return _axios.default.get("".concat(_this4.BASE_URL_API, "entity/").concat(entityType, "/").concat(uuid, "/icon").concat(_this4.buildURIParams({
            size: size,
            contextID: contextID
          })), _this4.DEFAULTCONFIG);
        },
        getEntityIconID: function getEntityIconID(entityType, uuid, contextID) {
          return _axios.default.get("".concat(_this4.BASE_URL_API, "entity/").concat(entityType, "/").concat(uuid, "/icon/id").concat(_this4.buildURIParams({
            contextID: contextID
          })), _this4.DEFAULTCONFIG);
        },
        getValueset: function getValueset(uuid) {
          return _axios.default.get("".concat(_this4.BASE_URL_API, "entity/valueset/").concat(uuid), _this4.DEFAULTCONFIG);
        },
        getPresentations: function getPresentations(entityArray) {
          return _axios.default.post("".concat(_this4.BASE_URL_API, "entity/presentations/"), entityArray, _this4.DEFAULTCONFIG);
        }
      };
    }
    /* Resource (Files) */
    ...
    value: function legacy() {
      ...
      return {
        executeMethod: function executeMethod(uuid, contextID, commit, inputArray) {
          var inputString = inputArray.reduce(function (acc, item) {
            acc += "&input=".concat(item);
            return acc;
          }, "");
          return _axios.default.get("".concat(_this6.BASE_URL, "services/authorized/").concat(contextID, "/execute/method/").concat(uuid, "?commit=").concat(commit).concat(inputString), _this6.DEFAULTCONFIG);
        },
        executeChange: function executeChange(uuid, contextID, commit, inputArray) {
          var inputString = inputArray.reduce(function (acc, item) {
            acc += "&input=".concat(item);
            return acc;
          }, "");
          return _axios.default.get("".concat(_this6.BASE_URL, "services/authorized/").concat(contextID, "/execute/change/").concat(uuid, "?commit=").concat(commit).concat(inputString), _this6.DEFAULTCONFIG);
        }
      };
    }
    /* Utility Functions */
